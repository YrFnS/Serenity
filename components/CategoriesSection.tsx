...
const categories = [
  {
    ...
    description: "Premium organic polishes and care kits for the perfect at-home manicure.",
    icon: (
  ...
  },
  {
    ...
    description: "Nourishing serums and tools to define and enhance your natural beauty.",
    icon: (
      <svg className="w-8 h-8 md:w-10 md:h-10" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    description: "Organic shampoos, conditioners, and treatments for luscious, healthy hair.",
    icon: (
      <svg className="w-8 h-8 md:w-10 md:h-10" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    key: "body-care",
    title: "Body Wellness",
    description: "Luxurious oils, lotions, and scrubs to pamper your skin and soothe your senses.",
    icon: (
      <svg className="w-8 h-8 md:w-10 md:h-10" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    description: "Clean, effective formulas for glowing, youthful skin at every age.",
    icon: (
      <svg className="w-8 h-8 md:w-10 md:h-10" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
            ...
            <br />
            <span className="text-[#C8A882]">Collections</span>
          </h2>

          <p className="font-sans text-lg text-gray-600 max-w-2xl mx-auto">
            Explore our exclusive range of organic products, each chosen to deliver profound results and a sense of deep tranquility at home.
          </p>
        </motion.div>
          ...
          >
            ...
            {[...categories, ...categories].map((category, index) => (
              <Link
                ...
                to={createPageUrl(`Shop?category=${category.key}`)}
