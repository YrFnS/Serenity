  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-16 relative">
        ...
        >
          At SERENITY, we exclusively use lab-tested, cruelty-free, and certified organic products for our wellness collection. Our commitment to sulfate-free, paraben-free, and alcohol-free formulations ensures your skin receives only the purest ingredients for a truly radiant, healthy glow.
        </motion.p>
      </div>
