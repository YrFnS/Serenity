...
const features = [
  {
    ...
    description: "State-of-the-art spa equipment for premium organic treatments in  "
  },
  {
    icon: Leaf,
    ...
    <section className="py-16 md:py-20 lg:py-24 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          >
            Welcome to SERENITY,  's premier luxury wellness sanctuary. We blend the expertise of master therapists with advanced technology and the purest organic ingredients. This is more than a treatment; it's a meticulously crafted experience designed to deliver profound results and restore your ultimate state of well-being.
          </motion.p>
        </motion.div>
          ...
          >
            ...
            >
              <img
                ...
                alt="A serene, luxurious organic spa treatment room at SERENITY Wellness Center in  , designed for ultimate relaxation."
          ...
          >
            ...
            >
              <img
                ...
                alt="A tranquil premium organic spa massage room, showcasing natural elements at SERENITY,  's leading luxury wellness destination."
                className="w-full h-full object-cover hover:scale-110 transition-transform duration-700"
              />
            </motion.div>
          </motion.div>
