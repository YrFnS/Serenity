...
const features = [
  {
    ...
    description: "Every product is rigorously tested for purity and potency to ensure maximum effectiveness."
  },
  {
    icon: Leaf,
    title: "100% Organic Ingredients",
    description: "Sourced from certified organic farms, our ingredients are free from harmful toxins."
  },
  {
    icon: Award,
    title: "Premium Quality",
    description: "Award-winning formulations that deliver visible results for your skin and body."
  },
  {
    icon: Heart,
    title: "Cruelty Free",
    ...
    <section className="py-16 md:py-20 lg:py-24 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          >
            Welcome to SERENITY, your destination for premium organic wellness. We curate only the finest products, blending nature's most potent ingredients with scientific innovation. Experience the transformative power of clean beauty, delivered directly to your doorstep.
          </motion.p>
        </motion.div>
          ...
          >
            ...
            >
              <img
                ...
                alt="Premium organic skincare products displayed in a serene setting."
          ...
          >
            ...
            >
              <img
                ...
                alt="Natural ingredients used in SERENITY products."
                className="w-full h-full object-cover hover:scale-110 transition-transform duration-700"
              />
            </motion.div>
          </motion.div>
        ...
        >
          <a
            href="/shop"
            className="inline-block bg-gradient-to-r from-[#C8A882] to-[#FF5C8D] text-white px-8 py-4 rounded-full font-sans font-semibold hover:from-[#FF5C8D] hover:to-[#C8A882] transition-all duration-300 shadow-lg text-lg"
          >
            Shop Our Collection
          </a>
        </motion.div>
