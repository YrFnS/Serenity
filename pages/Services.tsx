...
const servicesData = [
  // Massage Services (Unchanged)
  {
    ...
    category: "massage",
    description: "Indulge in a timeless classic at  's premier wellness destination. Our Swedish Massage utilizes masterful, flowing strokes and gentle kneading to dissolve muscle tension, enhance circulation, and guide you to a state of profound relaxation. This is the perfect introduction to therapeutic massage, meticulously performed by our certified therapists in   to restore your body's natural harmony.",
    price: 2500,
    duration: "60 min",
    ...
    alt_text: "Professional Swedish massage therapy session at SERENITY luxury spa in   - premium relaxation treatment"
  },
  {
    id: 2,
  ...
  },
  {
    ...
    alt_text: "Therapeutic head and shoulder massage for stress relief at SERENITY premium spa in    "
  },
  {
    id: 6,
    ...
    alt_text: "Deep tissue massage therapy for chronic pain relief at SERENITY luxury spa - professional treatment in  "
  },
  ...
  // Beauty & Cosmetic Services (Lashes & PMU)
  {
    ...
    alt_text: "Professional classic eyelash extensions application at SERENITY beauty salon  "
  },
   {
    id: 43,
    ...
    alt_text: "Textured hybrid lash extensions at SERENITY beauty salon  "
  },
  {
    id: 44,
  ...
  },
  {
    ...
    alt_text: "Dramatic volume lash extensions for maximum fullness at SERENITY  "
  },
  {
    id: 8,
    name: "Lash Lift",
    ...
    alt_text: "Before and after lash lift treatment showing natural curled lashes at SERENITY beauty salon  "
  },
  {
    id: 9,
    name: "Microblading",
    ...
    alt_text: "Expert microblading procedure for natural-looking, fuller eyebrows at SERENITY beauty clinic  "
  },
  {
    id: 10,
    name: "Microshading",
    ...
    alt_text: "Soft, powdered microshading eyebrow tattoo for a gradient brow look at SERENITY   salon"
  },
  {
    id: 11,
    name: "Combine Brows",
  ...
  },
   {
    ...
    alt_text: "Professional touch-up session for semi-permanent eyebrows at SERENITY luxury beauty studio  "
  },
  {
    id: 13,
    ...
    alt_text: "Lip blush semi-permanent makeup for enhanced lip color and shape at SERENITY beauty salon  "
  },
  {
    id: 47,
    name: "Lip Touch Up",
  ...
  },
  {
    ...
    alt_text: "Smudge-proof permanent eyeliner tattoo at SERENITY  "
  },
  {
    id: 49,
  ...
  // Skin Treatment
  {
    ...
    alt_text: "Advanced Hydra Facial for deep cleansing and hydration at SERENITY  "
  },
  {
    id: 52,
  ...
  },
  {
    ...
    alt_text: "Cece's Signature Facial - a bespoke luxury skin treatment at SERENITY  "
  },
  ...
  // Laser Hair Removal (Unchanged)
  {
    ...
    name: "Underarm Laser",
    category: "laser",
    description: "Embrace the freedom of flawlessly smooth underarms with our advanced laser hair removal. Using state-of-the-art, pain-free technology, we provide a safe and permanent solution to unwanted hair, ensuring you're confident and ready for any outfit, anytime. Discover the best laser hair removal in  .",
    price: 1000,
    duration: "30 min",
    ...
    alt_text: "Advanced laser hair removal for smooth underarms at SERENITY medical spa in  "
  },
  {
    id: 15,
    name: "Bikini Laser",
    category: "laser",
    description: "Achieve ultimate confidence with our discreet and professional Bikini Laser hair removal. Our certified technicians use cutting-edge equipment to ensure a comfortable experience and long-lasting, silky-smooth results. Say goodbye to razors and waxing forever at our   wellness center.",
    price: 2000,
    duration: "45 min",
  ...
  },
  {
    ...
    alt_text: "Comprehensive full leg laser hair removal for permanent smooth skin at SERENITY clinic  "
  },
  {
    id: 17,
    name: "Half Leg Laser",
    ...
    alt_text: "Targeted half leg laser hair removal for upper or lower legs at SERENITY spa  "
  },
  {
    id: 18,
    name: "Full Arm Laser",
  ...
  },
  {
    ...
    category: "laser",
    description: "Reveal a flawless complexion with our gentle yet effective Full Face Laser treatment. We safely remove unwanted hair from the upper lip, chin, cheeks, and sideburns, resulting in smoother skin and more even makeup application. It's a cornerstone of modern skincare, available at the best salon in  .",
    price: 1500,
    duration: "45 min",
    ...
    alt_text: "Gentle full face laser hair removal for flawless complexion at SERENITY skincare clinic  "
  },
  {
    id: 20,
    ...
    alt_text: "Effective full back laser hair removal for men and women at SERENITY aesthetic center  "
  },
  {
    id: 21,
    name: "Stomach Laser",
    category: "laser",
    description: "Gain confidence in your look with our effective and discreet Stomach Laser hair removal. This treatment safely and permanently removes unwanted hair from the abdominal area, leading to smoother, clearer skin. It's a popular choice at our   luxury spa.",
    price: 2000,
    duration: "45 min",
    ...
    alt_text: "Safe and effective stomach laser hair removal for clear skin at SERENITY luxury spa  "
  },
  {
    id: 22,
  ...
  // Nail Services
  {
    ...
    alt_text: "Elegant soft gel nail extensions for natural-looking, durable manicure at SERENITY nail salon  "
  },
  {
    id: 25,
  ...
  },
  {
    ...
    alt_text: "Trendy Douyin style nail extensions at SERENITY nail salon  "
  },
  {
    id: 26,
    name: "Gel Polish",
    ...
    alt_text: "Flawless, long-lasting gel polish application with vast color selection at SERENITY nail bar  "
  },
  {
    id: 56,
    ...
    alt_text: "Classic manicure service including nail shaping, cuticle care, and hand massage at SERENITY spa  "
  },
  {
    id: 57,
  ...
  },
  {
    ...
    alt_text: "Rejuvenating pedicure with foot soak, exfoliation, and massage for tired feet at SERENITY spa  "
  },
  {
    id: 59,
  ...
  // Hair Services (Unchanged)
  {
    ...
    name: "Women Hair Cut",
    category: "hair",
    description: "Transform your look with a bespoke Women's Hair Cut from our master stylists in  . Following a thorough consultation, we will craft a style that perfectly complements your face shape, hair type, and lifestyle, using precision cutting techniques for a flawless finish.",
    price: 800,
    duration: "60 min",
    image_url: "https://images.pexels.com/photos/3065209/pexels-photo-3065209.jpeg?auto=compress&cs=tinysrgb&w=600&q=80",
    alt_text: "Bespoke women's haircut by master stylists at SERENITY hair salon   - precision cutting and styling"
  },
  {
    id: 33,
    name: "Men Hair Cut",
    ...
    alt_text: "Expert men's haircut with modern barbering techniques and styling at SERENITY salon for men  "
  },
  {
    id: 34,
    name: "Hair Wash",
  ...
  },
  {
    ...
    alt_text: "Professional hair wash and styling for a perfect blowout or event-ready look at SERENITY salon  "
  },
  {
    id: 36,
    name: "Hair Perming",
    category: "hair",
    description: "Create beautiful, lasting texture with our expert Hair Perming services. Whether you desire soft, beachy waves or vibrant, bouncy curls, our stylists use advanced, gentle formulas to achieve your desired look while maintaining the health and integrity of your hair. Find the best hair perming in   here.",
    price: 2500,
    duration: "180 min",
    ...
    priceNote: "Starting",
    alt_text: "Expert hair perming for soft waves or bouncy curls using gentle formulas at SERENITY hair studio  "
  },
  {
    id: 37,
  ...
  },
  {
    ...
    priceNote: "Starting",
    alt_text: "Premium hair colouring services including balayage and highlights with luminous results at SERENITY  "
  },
  {
    id: 39,
    name: "Hair Highlight",
  ...
  },
  {
    ...
    name: "Hair Extension",
    category: "hair",
    description: "Instantly add luxurious length and volume with our premium Hair Extensions. We use only 100% human hair, expertly applied by our certified specialists for a seamless, natural, and comfortable blend. Transform your look in a single session at our   salon.",
    price: 1499,
    duration: "120 min",
    ...
    priceNote: "Starting",
    alt_text: "Luxury hair extensions for added length and volume using 100% human hair at SERENITY salon  "
  },
  {
    id: 41,
    name: "Hair Spa",
  ...
  },
  {
    ...
    priceNote: "Starting",
    alt_text: "Transformative keratin treatment for smooth, frizz-free, and manageable hair at SERENITY salon  "
  }
];
        ...
        >
          <div className="bg-white rounded-3xl p-12 shadow-lg border border-[#C8A882]/20">
            ...
            <p className="text-gray-600 mb-8 max-w-2xl mx-auto leading-[1.618]">
              ...
              that have made SERENITY the #1 spa in  .
            </p>
            <button 
